...
export class BaseNotificationDto {
  ...
  @ApiProperty({
    description:
      'List of trigger IDs associated with this notification (UUIDv4)',
    example: [
      'd290f1ee-6c54-4b01-90e6-d701748f0851',
      'eac8b334-70b9-4de4-8019-3946eae8b1e5',
    ],
    type: [String],
  })
  trigger_ids: string[];
  ...
  @ApiPropertyOptional({
    description:
      'Message sent in case the trigger is a message from another user',
    example: 'Hello!',
    type: String,
  })
  chatMessage?: string;
