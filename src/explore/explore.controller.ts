...
export class ExploreController {
  ...
  @Get()
  async root() {
    return this.exploreService.root();
  }
  ...
  @ApiQuery({ name: 'category', required: false, enum: ['none', 'sports', 'entertainment'] })
  ...
  async getTrending(
    ...
    return await this.exploreService.getTrending(category, country);
  }
  ...
  async getWhoToFollow() {
    return await this.exploreService.getWhoToFollow();
  }
  ...
  @ApiQuery({ name: 'category', required: false, enum: ['sports', 'music', 'news', 'entertainment'] })
  @Get('for-you-posts')
  async getForYouPosts(@Query('category') category?: string) {
    return await this.exploreService.getForYouPosts(category);
  }
}
