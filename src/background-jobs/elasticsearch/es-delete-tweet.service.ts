...
@Injectable()
export class EsDeleteTweetJobService extends BackgroundJobsService<ElasticsearchSyncTweetDto> {
    ...
    async queueDeleteTweet(dto: ElasticsearchSyncTweetDto, priority?: number, delay?: number) {
