...
export class InitialSchema1761833961975 implements MigrationInterface {
    name = 'InitialSchema1761833961975';
    ...
    public async up(query_runner: QueryRunner): Promise<void> {
        ...
        await query_runner.query(
            `CREATE TABLE "tweets" ("tweet_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "content" text NOT NULL, "images" text array NOT NULL DEFAULT '{}', "videos" text array NOT NULL DEFAULT '{}', "num_likes" integer NOT NULL DEFAULT '0', "num_reposts" integer NOT NULL DEFAULT '0', "num_views" integer NOT NULL DEFAULT '0', "num_quotes" integer NOT NULL DEFAULT '0', "num_replies" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_708f1ea2bb138c6bf68ca3a765a" PRIMARY KEY ("tweet_id"))`
        );
        await query_runner.query(
        ...
        await query_runner.query(
            `CREATE TABLE "user_interests" ("user_id" uuid NOT NULL, "category_id" smallint NOT NULL, "score" integer NOT NULL DEFAULT '50', CONSTRAINT "PK_2d110e573adc4c39c6efb0e092e" PRIMARY KEY ("user_id", "category_id"))`
        );
        await query_runner.query(
